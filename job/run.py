...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument("-px", "--plot_size_x", type=int)
    parser.add_argument("-py", "--plot_size_y", type=int)
    parser.add_argument("-st", "--output_start_time", type=int)
    parser.add_argument("-et", "--output_end_time", type=int)
