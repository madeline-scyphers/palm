...
from parameters import canopy_path, config_path, data_path, job_path, lad_path
...
def get_runner(job):
    ...
    runner = AnalyzeRun(data_path_3d=data, data_path_lad=lad, run_config=config, canopy_csv=canopy)
    return runner
